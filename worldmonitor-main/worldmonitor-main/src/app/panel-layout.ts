...
export class PanelLayoutManager implements AppModule {
  ...
  renderLayout(): void {
    const showAppSwitcher = this.ctx.isDesktopApp || location.hostname === 'localhost' || location.hostname === '127.0.0.1';
    const bridgeHref = showAppSwitcher ? 'http://127.0.0.1:3000/' : '/';
    const dalalHref = showAppSwitcher ? 'http://127.0.0.1:3000/terminal' : '/terminal';
    ...
    this.ctx.container.innerHTML = `
      ...
      <div class="header">
        ...
        <div class="header-right">
          ${showAppSwitcher ? `
            <div class="app-switcher" aria-label="App switcher">
              <a href="${bridgeHref}" class="app-switcher__link">Bridge</a>
              <a href="${dalalHref}" class="app-switcher__link">Dalal</a>
              <span class="app-switcher__link app-switcher__link--active">World Monitor</span>
            </div>` : ''}
      ...
      <nav class="mobile-menu" id="mobileMenu">
        ...
        ${showAppSwitcher ? `
          <div class="mobile-menu-divider"></div>
          <a class="mobile-menu-item" href="${bridgeHref}">
            <span class="mobile-menu-item-icon">⬡</span>
            <span class="mobile-menu-item-label">Bridge</span>
          </a>
          <a class="mobile-menu-item" href="${dalalHref}">
            <span class="mobile-menu-item-icon">◈</span>
            <span class="mobile-menu-item-label">Dalal Wire</span>
          </a>
          <span class="mobile-menu-item active">
            <span class="mobile-menu-item-icon">◎</span>
            <span class="mobile-menu-item-label">World Monitor</span>
